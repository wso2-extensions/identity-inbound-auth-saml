...
package org.wso2.carbon.identity.sso.samlnew.internal;
 ...
 * interface="org.wso2.carbon.identity.sso.samlnew.processor.SPInitSSOAuthnRequestProcessor" cardinality="0..n"
 * policy="dynamic" bind="addAuthnRequestProcessor" unbind="removeAuthnRequestProcessor"
 * @scr.reference name="saml.request.factory"
 * interface="org.wso2.carbon.identity.sso.samlnew.bean.message.request.SAMLIdentityRequestFactory" cardinality="0..n"
