...
public class SAMLAssertionFinderImpl implements SAMLAssertionFinder {
    protected static final Log log = LogFactory.getLog(SAMLAssertionFinderImpl.class);
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                try {
                    ...
                    log.info("Assertions retrieved from database");
                } catch (Exception e) {
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                try {
                    ...
                    log.info("Assertion is retrieved from database");
                    return assertion;
                } catch (Exception e) {
                    log.error(e);
                }
