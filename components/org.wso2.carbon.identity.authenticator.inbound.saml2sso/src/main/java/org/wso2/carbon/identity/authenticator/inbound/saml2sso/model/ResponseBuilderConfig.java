...
public class ResponseBuilderConfig implements Serializable {
    ...
    private static final long serialVersionUID = -1324073152816404920L;
...
//        final StringBuffer sb = new StringBuffer("ResponseBuilderConfig{");
//        sb.append("defaultAssertionConsumerUrl='").append(getDefaultAssertionConsumerUrl()).append('\'');
//        sb.append(", nameIdFormat='").append(getNameIdFormat()).append('\'');
//        sb.append(", notOnOrAfterPeriod=").append(getNotOnOrAfterPeriod());
...
//        sb.append(", requestedAudiences=").append(getRequestedAudiences());
//        sb.append(", requestedRecipients=").append(getRequestedRecipients());
//        sb.append(", digestAlgorithmUri='").append(getDigestAlgorithmUri()).append('\'');
//        sb.append(", signingAlgorithmUri='").append(getSigningAlgorithmUri()).append('\'');
//        sb.append(", gnResponse=").append(signResponse());
//        sb.append(", cryptAssertion=").append(encryptAssertion());
//        sb.append(", encryptionCertificate='").append(getEncryptionCertificate()).append('\'');
//        sb.append('}');
//        return sb.toString();
//    }
}
