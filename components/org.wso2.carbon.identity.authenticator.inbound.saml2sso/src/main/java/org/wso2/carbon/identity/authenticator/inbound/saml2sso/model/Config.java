...
import org.wso2.carbon.identity.authenticator.inbound.saml2sso.internal.SAML2InboundAuthActivator;
...
//        sb.append("ssoResponseHtml='").append(ssoResponseHtml).append('\'');
//        sb.append(", idpEntityId='").append(idpEntityId).append('\'');
//        sb.append(", destinationUrls=").append(destinationUrls);
//        sb.append(", errorPageUrl='").append(errorPageUrl).append('\'');
//        sb.append('}');
//        return sb.toString();
//    }
}
