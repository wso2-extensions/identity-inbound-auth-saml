...
public class SPInitRequest extends SAML2SSORequest {
    ...
    private static final long serialVersionUID = 7785061456909986055L;
...
//        final StringBuffer sb = new StringBuffer("SPInitRequest{");
//        sb.append("SAMLRequest='").append(getSAMLRequest()).append('\'');
