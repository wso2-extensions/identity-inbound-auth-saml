...
public class SAMLSSOSoapMessageService {
    ...
    private void setRequestProperties(String url, String message, HttpPost httpPost) {
        ...
        httpPost.addHeader(SAMLSSOConstants.CONTENT_TYPE_PARAM_KEY, CONTENT_TYPE);
        httpPost.addHeader(SAMLSSOConstants.ACCEPT_PARAM_KEY, CONTENT_TYPE);
        String sbSOAPAction = "\"" + url + "\"";
        httpPost.addHeader(SAMLSSOConstants.SOAP_ACTION_PARAM_KEY, sbSOAPAction);
        httpPost.addHeader(SAMLSSOConstants.PRAGMA_PARAM_KEY, "no-cache");
        httpPost.addHeader(SAMLSSOConstants.CACHE_CONTROL_PARAM_KEY, "no-cache, no-store");
